...
class _AbstractCell:
    ...
    def array(self, value):
        ...
        self._array = value
        self.entry = value[0]
        self.entry_object = value[2]
        self.entry_unit = value[3]
        self.entry_zone = value[4]
        self.entry_effect = value[5]
        self.entry_fow = value[6]
...
class Cell(_AbstractCell):
    ...
    def __init__(
            ...
            coordinates: _Optional[tuple[int, int]] = None,
        ...
        if parentgrid is not None:
            ...
            self.row_name = designation[:-5]
            self.row_index = self.entry['row_index']

            self.col_name = designation[-5:]
            self.col_index = self.entry['col_index']

            self.array = self.parentgrid.grid_array[self.col_index][self.row_index]

            self.coordinates = coordinates if coordinates is not None else self.entry['coordinates']
