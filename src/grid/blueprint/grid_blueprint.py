...
class BaseGridBlueprint(AbstractGridBlueprint):
    ...
    def __init__(self, cell_size: int = None, grid_dimensions: tuple[int, int] = None, grid_id: str = None, array: np.ndarray = None, quadrants: dict = None, graph: dict = None):
